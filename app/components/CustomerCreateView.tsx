...
export function CustomerCreateView({ onSave, onCancel, initialDraft, title = "Ny kund" }: CustomerCreateViewProps) {
    ...
    <>
      <div className={styles.contractModernTopRow}>
        ...
        <div className={styles.contractModernTopActions}>
          ...
          <Button className={styles.contractQuickActionButton} size="small" onClick={onCancel}>
            Avbryt
          </Button>
        </div>
      </div>
