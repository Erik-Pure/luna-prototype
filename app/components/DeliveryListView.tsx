...
const FIELD_SETS = [
  {
    ...
    fields: [
      ...
      { key: "leveranssatt", label: "Leveranssätt", control: "select" as const, options: deliverySelectOptions.leveranssatt, multi: true },
      ...
      { key: "utlastandeEnhet", label: "Utlastande enhet", control: "select" as const, options: deliverySelectOptions.utlastandeEnhet, multi: true },
      { key: "ansvarigEnhet", label: "Ansvarig enhet", control: "select" as const, options: deliverySelectOptions.ansvarigEnhet, multi: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "p_kvalitet", label: "Kvalitet", control: "select" as const, options: deliverySelectOptions.kvalitet, multi: true },
...
const BOTTOM_TABLE_COLUMNS = [
  ...
  ] as string[]).map((label) => ({ key: label, label: label === "Enhet" ? "Beställd enhet" : label, visible: true })),
];

const BOTTOM_TABLE_ROWS = [
  {
    "Utlastande enhet": "BP Hissmofors", "KontraktsNr": "K-2024-001", "Avroprad nr": "001",
  ...
  {
    "Utlastande enhet": "BP Kramfors", "KontraktsNr": "K-2024-002", "Avroprad nr": "002",
  ...
  {
    "Utlastande enhet": "BP Bollstabruk", "KontraktsNr": "K-2024-003", "Avroprad nr": "003",
...
export function DeliveryListView({ onAndraStatus }: DeliveryListViewProps = {}) {
  ...
  const andraDetaljerInitial = selectedRow
    ? {
      ...
      utlastandeEnhet: selectedRow["Utlastande enhet"] ?? "",
